                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="tags">文章标签</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">留言板</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="form_basic.html">留言列表</a>
                            </li>
                            <li><a class="J_menuItem" href="form_validate.html">。。。</a>
							</li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="Admin/index_v3.html">首页</a>
                    </div>
                </nav>
