...
<body class="gray-bg">
    ...
    <script src="{{asset('public/Admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    ...
    <script src="{{asset('public/Admin/js/demo/sparkline-demo.min.js')}}"></script>
    <script>
